...
ngx_rtmp_kmp_api_upstream_json_get_size(ngx_kmp_push_upstream_t *obj)
{
    size_t result =
        ...
        sizeof("\",\"addr_text\":\"") - 1 + obj->addr_text.len +
            ngx_escape_json(NULL, obj->addr_text.data, obj->addr_text.len) +
...
ngx_rtmp_kmp_api_upstream_json_write(u_char *p, ngx_kmp_push_upstream_t *obj)
{
    ...
    p = ngx_copy(p, "\",\"addr_text\":\"", sizeof("\",\"addr_text\":\"") - 1);
    p = (u_char*)ngx_escape_json(p, obj->addr_text.data, obj->addr_text.len);
    ...
    ngx_rtmp_codec_ctx_t *codec_ctx)
{
    ...
    size_t result =
        ...
        sizeof("\",\"memory_left\":") - 1 + NGX_SIZE_T_LEN +
        sizeof(",\"codec_info\":") - 1 +
    ...
    ngx_rtmp_codec_ctx_t *codec_ctx)
{
    ...
    p = ngx_copy(p, "\",\"channel_id\":\"", sizeof("\",\"channel_id\":\"") -
        1);
    p = (u_char*)ngx_escape_json(p, obj->channel_id.data, obj->channel_id.len);
    p = ngx_copy(p, "\",\"track_id\":\"", sizeof("\",\"track_id\":\"") - 1);
    p = (u_char*)ngx_escape_json(p, obj->track_id.data, obj->track_id.len);
    p = ngx_copy(p, "\",\"memory_left\":", sizeof("\",\"memory_left\":") - 1);
    p = ngx_sprintf(p, "%uz", (size_t)obj->memory_limit);
