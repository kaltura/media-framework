...
static ngx_int_t ngx_live_variable_live_version(ngx_live_variables_ctx_t *ctx,
    ngx_live_variable_value_t *v, uintptr_t data);
...
static ngx_live_variable_t  ngx_live_core_variables[] = {
    ...
    { ngx_string("live_version"), NULL, ngx_live_variable_live_version,
      0, 0, 0 },
...
static ngx_int_t
ngx_live_variable_live_version(ngx_live_variables_ctx_t *ctx,
    ngx_live_variable_value_t *v, uintptr_t data)
{
    v->len = sizeof(NGX_LIVE_VERSION) - 1;
    v->valid = 1;
    v->no_cacheable = 0;
    v->not_found = 0;
    v->data = (u_char *) NGX_LIVE_VERSION;
