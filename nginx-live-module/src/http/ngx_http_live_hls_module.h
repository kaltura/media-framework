#ifndef _NGX_HTTP_LIVE_HLS_MODULE_H_INCLUDED_
#define _NGX_HTTP_LIVE_HLS_MODULE_H_INCLUDED_
...
extern ngx_module_t  ngx_http_live_hls_module;

#endif /* _NGX_HTTP_LIVE_HLS_MODULE_H_INCLUDED_ */
