...
ngx_live_period_json_write(u_char *p, ngx_live_period_t *obj)
{
    ...
    p = ngx_copy(p, ",\"segment_count\":", sizeof(",\"segment_count\":") - 1);
...
ngx_live_timeline_json_write(u_char *p, ngx_live_timeline_t *obj)
{
    ...
    p = ngx_copy(p, ",\"duration\":", sizeof(",\"duration\":") - 1);
    p = ngx_sprintf(p, "%uL", (uint64_t) obj->duration);
    p = ngx_copy(p, ",\"periods\":[", sizeof(",\"periods\":[") - 1);
...
{
    p = ngx_copy(p, "\"timelines\":", sizeof("\"timelines\":") - 1);
