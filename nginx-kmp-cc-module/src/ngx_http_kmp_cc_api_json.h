...
ngx_http_kmp_cc_api_json_get_size(void *obj)
{
    ...
    result =
        sizeof("{\"version\":\"") - 1 +
            ngx_json_str_get_size(&ngx_kmp_cc_version) +
        sizeof("\",\"nginx_version\":\"") - 1 +
            ngx_json_str_get_size(&ngx_kmp_cc_nginx_version) +
        sizeof("\",\"compiler\":\"") - 1 +
            ngx_json_str_get_size(&ngx_kmp_cc_compiler) +
        sizeof("\",\"built\":\"") - 1 +
            ngx_json_str_get_size(&ngx_kmp_cc_built) +
...
ngx_http_kmp_cc_api_json_write(u_char *p, void *obj)
{
    ...
    p = ngx_json_str_write(p, &ngx_kmp_cc_version);
    p = ngx_copy_fix(p, "\",\"nginx_version\":\"");
    p = ngx_json_str_write(p, &ngx_kmp_cc_nginx_version);
    p = ngx_copy_fix(p, "\",\"compiler\":\"");
    p = ngx_json_str_write(p, &ngx_kmp_cc_compiler);
    p = ngx_copy_fix(p, "\",\"built\":\"");
    p = ngx_json_str_write(p, &ngx_kmp_cc_built);
