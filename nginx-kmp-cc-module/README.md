...
Sets the URL of the HTTP `unpublish` callback, called whenever a CC channel stops being published, or some unrecoverable error occurs when sending to upstream.
