...
typedef struct ngx_live_persist_conf_s  ngx_live_persist_conf_t;
...
ngx_live_persist_conf_t *ngx_live_persist_conf_create(ngx_conf_t *cf,
    ngx_uint_t ctx_count);

ngx_int_t ngx_live_persist_conf_add_blocks(ngx_conf_t *cf,
    ngx_live_persist_conf_t *conf, ngx_live_persist_block_t *blocks);

ngx_int_t ngx_live_persist_conf_init(ngx_conf_t *cf,
    ngx_live_persist_conf_t *conf);


ngx_int_t ngx_live_persist_conf_write_blocks(ngx_live_persist_conf_t *conf,
    ngx_log_t *log, ngx_live_persist_write_ctx_t *write_ctx,
    ngx_uint_t block_ctx, void *obj);

ngx_int_t ngx_live_persist_conf_read_blocks(ngx_live_persist_conf_t *conf,
