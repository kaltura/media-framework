...
/* ngx_ts_kmp_track_mpegts_json writer */
    ...
    ngx_connection_t *c)
{
    ...
    result =
        ...
        sizeof(",\"addr\":\"") - 1 + c->addr_text.len + ngx_escape_json(NULL,
    ...
    ngx_connection_t *c)
{
    ...
    p = ngx_sprintf(p, "%uD", (uint32_t) obj->index);
...
ngx_ts_kmp_track_json_write(u_char *p, ngx_ts_kmp_publish_t *obj,
    ngx_connection_t *c)
{
    p = ngx_copy_fix(p, "\"input_type\":\"mpegts\",\"mpegts\":");
    p = ngx_ts_kmp_track_mpegts_json_write(p, obj, c);
