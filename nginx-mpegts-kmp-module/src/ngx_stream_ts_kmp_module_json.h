...
/* ngx_stream_ts_kmp_track_json writer */

static size_t
ngx_stream_ts_kmp_track_json_get_size(ngx_ts_kmp_track_t *obj)
{
    size_t  result;
...
static u_char *
ngx_stream_ts_kmp_track_json_write(u_char *p, ngx_ts_kmp_track_t *obj)
{
...
/* ngx_stream_ts_kmp_session_json writer */

static size_t
ngx_stream_ts_kmp_session_json_get_size(ngx_ts_kmp_ctx_t *obj)
{
    size_t               result;
    ngx_queue_t         *q;
        ...
        q = ngx_queue_next(q))
    {
        ...
        result += ngx_stream_ts_kmp_track_json_get_size(cur) + sizeof(",") - 1;
    }
...
static u_char *
ngx_stream_ts_kmp_session_json_write(u_char *p, ngx_ts_kmp_ctx_t *obj)
{
    ngx_queue_t         *q;
    ngx_ts_kmp_track_t  *cur;
        ...
        q = ngx_queue_next(q))
    {
        ...
        p = ngx_stream_ts_kmp_track_json_write(p, cur);
    }
...
/* ngx_stream_ts_kmp_server_json writer */

static size_t
ngx_stream_ts_kmp_server_json_get_size(ngx_stream_core_srv_conf_t *obj)
{
    size_t                         result;
    ngx_queue_t                   *q;
    ...
    tscf = ngx_stream_get_module_srv_conf(obj->ctx, ngx_stream_ts_kmp_module);
    result =
        sizeof("{\"sessions\":[") - 1 +
        sizeof("]}") - 1;
        ...
        q = ngx_queue_next(q))
    {
        ...
        result += ngx_stream_ts_kmp_session_json_get_size(cur) + sizeof(",") -
            1;
    }
...
static u_char *
ngx_stream_ts_kmp_server_json_write(u_char *p, ngx_stream_core_srv_conf_t *obj)
{
    ngx_queue_t                   *q;
    ngx_ts_kmp_ctx_t              *cur;
    ngx_stream_ts_kmp_srv_conf_t  *tscf;
        ...
        q = ngx_queue_next(q))
    {
        ...
        p = ngx_stream_ts_kmp_session_json_write(p, cur);
    }
...
/* ngx_stream_ts_kmp_stream_json writer */

size_t
ngx_stream_ts_kmp_stream_json_get_size(void *obj)
{
    size_t                        result;
    ngx_uint_t                    n;
    ...
    for (n = 0; n < cmcf->servers.nelts; n++) {
        ...
        result += ngx_stream_ts_kmp_server_json_get_size(cur) + sizeof(",") -
            1;
    }
...
u_char *
ngx_stream_ts_kmp_stream_json_write(u_char *p, void *obj)
{
    ngx_uint_t                    n;
    ngx_stream_core_srv_conf_t   *cur;
    ngx_stream_core_main_conf_t  *cmcf;
    ...
    for (n = 0; n < cmcf->servers.nelts; n++) {
        ...
        p = ngx_stream_ts_kmp_server_json_write(p, cur);
    }
