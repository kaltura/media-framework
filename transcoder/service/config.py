import argparse
from service_utils import get_host_ip_address
...
parser.add_argument('--bind_ip_address', dest='bind_ip_address', type=str, action='store', default=get_host_ip_address(), help="specific ip address to bind transcoder enpoints to")
